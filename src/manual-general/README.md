...
<img :src="$withBase('/img/configuracion-general-1.png')" width="200" height="500" hspace="200" vspace="50">

Se abrirá la siguiente vista.

<img :src="$withBase('/img/configuracion-general-2.png')" width="700" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-1.png')" width="700" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-2.png')" width="550" height="100" hspace="100" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-4.png')" width="550" height="100" hspace="100" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-6.png')" width="700" height="700" hspace="0" vspace="0">

Texto del botón de la tienda: Agregue el texto del botón, este aparece
como parte del Banner principal.

<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-7.png')" width="500" height="100" hspace="100" vspace="50">

Banner principal con el botón de la tienda.

<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-8.png')" width="700" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-10.png')" width="700" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ejemplo-de-llenado-de-datos-11.png')" width="500" height="100" hspace="100" vspace="50">
...
<img :src="$withBase('/img/mostrar-u-ocultar-informacion-1.png')" width="500" height="200" hspace="100" vspace="50">

Se puede personalizar el color del sitio web y la fuente que tendrá la 
tienda:

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-2.png')" width="500" height="250" hspace="100" vspace="50">
...
<img :src="$withBase('/img/mostrar-u-ocultar-informacion-3.png')" width="600" height="250" hspace="50" vspace="50">

Selecciona la posición del Menú de categorías (Final, Inicio o 
Centrado).

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-4.png')" width="300" height="250" hspace="200" vspace="50">

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-5.png')" width="900" height="500" hspace="0" vspace="0">
...
<img :src="$withBase('/img/mostrar-u-ocultar-informacion-6.png')" width="500" height="100" hspace="100" vspace="50">

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-7.png')" width="350" height="300" hspace="200" vspace="0">
...
<img :src="$withBase('/img/mostrar-u-ocultar-informacion-8.png')" width="500" height="150" hspace="100" vspace="50">
...
<img :src="$withBase('/img/mostrar-u-ocultar-informacion-9.png')" width="550" height="100" hspace="100" vspace="50">

Compra por WhatsApp

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-10.png')" width="900" height="300" hspace="0" vspace="50">

Compra mediante Carrito de compras

<img :src="$withBase('/img/mostrar-u-ocultar-informacion-11.png')" width="900" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/catalogo-virtual-1.png')" width="200" height="200" hspace="250" vspace="50">

Escriba el nombre que aparecerá para identificar a su catálogo virtual 
en su página web.

<img :src="$withBase('/img/catalogo-virtual-2.png')" width="550" height="100" hspace="100" vspace="50">

Cuando usted lo prefiera puede mostrar u ocultar su catálogo en su 
tienda virtual.

<img :src="$withBase('/img/catalogo-virtual-3.png')" width="250" height="100" hspace="200" vspace="50">

Una vez que se ingresen los datos necesarios y obligatorios se da 
click en el botón Guardar.

<img :src="$withBase('/img/catalogo-virtual-4.png')" width="250" height="100" hspace="200" vspace="50">

Los cambios hechos en la Configuración de la Tienda se verán 
reflejados en la pantalla principal de su página web.

<img :src="$withBase('/img/catalogo-virtual-5.png')" width="750" height="50" hspace="0" vspace="50">

Escriba el texto que aparecerá como botón a su tienda de 
productos. Elija si desea mostrar u ocultar el botón.

<img :src="$withBase('/img/catalogo-virtual-6.png')" width="750" height="150" hspace="0" vspace="50">

Esta sección aparecerá del lado superior derecho de su página web.

<img :src="$withBase('/img/catalogo-virtual-7.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/configuracion-de-productos-1.png')" width="750" height="150" hspace="0" vspace="50">
...
<img :src="$withBase('/img/configuracion-de-productos-2.png')" width="750" height="100" hspace="0" vspace="50">

Escriba el texto que desee que aparezca en el apartado de sus 
proveedores o clientes.

<img :src="$withBase('/img/configuracion-de-productos-3.png')" width="750" height="150" hspace="0" vspace="50">
...
<img :src="$withBase('/img/configuracion-de-productos-4.png')" width="750" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/configuracion-de-productos-5.png')" width="750" height="150" hspace="0" vspace="50">
...
<img :src="$withBase('/img/logos-y-banners-1.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/icono-tabulador-2.png')" width="200" height="200" hspace="250" vspace="50">

Al terminar el proceso, el ícono que el usuario eligió se mostrará de 
la siguiente forma.

<img :src="$withBase('/img/icono-tabulador-3.png')" width="200" height="350" hspace="250" vspace="50">

Se verá un recuadro como el siguiente:

<img :src="$withBase('/img/icono-tabulador-4.png')" width="150" height="50" hspace="250" vspace="50">
...
<img :src="$withBase('/img/icono-tabulador-5.png')" width="100" height="100" hspace="250" vspace="50">
...
<img :src="$withBase('/img/logo-principal-2.png')" width="200" height="200" hspace="250" vspace="50">

Al terminar el proceso, el logo que el usuario eligió se mostrará de la 
siguiente forma.

<img :src="$withBase('/img/logo-principal-3.png')" width="200" height="400" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-principal-2.png')" width="200" height="200" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-principal-3.png')" width="200" height="400" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-principal-4.png')" width="200" height="200" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-principal-5.png')" width="200" height="100" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-principal-6.png')" width="250" height="250" hspace="250" vspace="50">

Recorte la imagen.

<img :src="$withBase('/img/banner-principal-7.png')" width="250" height="350" hspace="250" vspace="50">

Al finalizar el proceso tendrá la siguiente vista.

<img :src="$withBase('/img/banner-principal-8.png')" width="300" height="350" hspace="250" vspace="50">
...
<img :src="$withBase('/img/cambiar-color-1.png')" width="400" height="200" hspace="150" vspace="50">
...
<img :src="$withBase('/img/footer-2.png')" width="200" height="200" hspace="250" vspace="50">

Al terminar el proceso, el footer que el usuario eligió se mostrará de 
la siguiente forma.

<img :src="$withBase('/img/footer-3.png')" width="200" height="400" hspace="250" vspace="50">
...
<img :src="$withBase('/img/footer-4.png')" width="400" height="150" hspace="150" vspace="50">

Elija la proporción que prefiera que aparezca en la versión de 
escritorio de su Footer.

<img :src="$withBase('/img/footer-5.png')" width="400" height="200" hspace="200" vspace="50">
...
<img :src="$withBase('/img/footer-6.png')" width="350" height="500" hspace="200" vspace="50">
...
<img :src="$withBase('/img/banner-secundario-2.png')" width="200" height="200" hspace="250" vspace="50">

Al terminar el proceso, el banner secundario que el usuario eligió se 
mostrará de la siguiente forma.

<img :src="$withBase('/img/banner-secundario-3.png')" width="150" height="400" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-secundario-4.png')" width="450" height="150" hspace="150" vspace="50">

Elija la proporción que desee para su Banner secundario en la 
versión de escritorio. 

<img :src="$withBase('/img/banner-secundario-5.png')" width="400" height="200" hspace="150" vspace="50">
...
<img :src="$withBase('/img/banner-secundario-6.png')" width="200" height="400" hspace="250" vspace="50">

Recorte la imagen.

<img :src="$withBase('/img/banner-secundario-7.png')" width="300" height="250" hspace="250" vspace="50">

Al finalizar el proceso, tendrá la siguiente vista.

<img :src="$withBase('/img/banner-secundario-8.png')" width="250" height="400" hspace="250" vspace="50">

En caso de necesitarlo, puede escribir un texto para que aparezca 
en su Banner.

<img :src="$withBase('/img/banner-secundario-9.png')" width="750" height="100" hspace="0" vspace="50">

Marque si desea mostrarlo u ocultarlo y elija el color que quiere 
para el texto.

<img :src="$withBase('/img/banner-secundario-10.png')" width="300" height="250" hspace="200" vspace="50">

Seleccione la alineación, tamaño y peso que prefiera para el texto.

<img :src="$withBase('/img/banner-secundario-11.png')" width="300" height="200" hspace="200" vspace="50">
...
<img :src="$withBase('/img/banner-intermedio-2.png')" width="250" height="250" hspace="250" vspace="50">

Al terminar el proceso, el banner intermedio que el usuario eligió se 
mostrará de la siguiente forma.

<img :src="$withBase('/img/banner-intermedio-3.png')" width="150" height="400" hspace="250" vspace="50">
...
<img :src="$withBase('/img/banner-intermedio-4.png')" width="350" height="150" hspace="200" vspace="50">

Elija la proporción que desee para su Banner intermedio en la 
versión de escritorio. 

<img :src="$withBase('/img/banner-intermedio-5.png')" width="350" height="200" hspace="200" vspace="50">

Puede agregar una imagen como banner intermedio para la versión 
de teléfono móvil. Arrastre una imagen o haga click en el recuadro 
para seleccionar un archivo.

<img :src="$withBase('/img/banner-intermedio-6.png')" width="250" height="400" hspace="250" vspace="50">

Recorte la imagen.

<img :src="$withBase('/img/banner-intermedio-7.png')" width="250" height="250" hspace="250" vspace="50">

Al finalizar el proceso, tendrá la siguiente vista.

<img :src="$withBase('/img/banner-intermedio-8.png')" width="250" height="400" hspace="250" vspace="50">

En caso de necesitarlo, puede escribir un texto para que aparezca 
en su Banner.

<img :src="$withBase('/img/banner-intermedio-9.png')" width="750" height="100" hspace="0" vspace="50">

Marque si desea mostrarlo u ocultarlo y elija el color que quiere 
para el texto. 

<img :src="$withBase('/img/banner-intermedio-10.png')" width="350" height="250" hspace="200" vspace="50">
...
<img :src="$withBase('/img/galeria-1.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/agregar-galeria-1.png')" width="750" height="300" hspace="0" vspace="50">

En el recuadro que aparece, se arrastra la imagen o se da click para 
agregar la imagen.

<img :src="$withBase('/img/agregar-galeria-2.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/agregar-galeria-3.png')" width="500" height="500" hspace="100" vspace="50">

Tu imagen aparece en la ventana de galería (desactivado).

<img :src="$withBase('/img/agregar-galeria-4.png')" width="500" height="400" hspace="100" vspace="50">
...
<img :src="$withBase('/img/agregar-categoria-1.png')" width="600" height="200" hspace="50" vspace="50">
...
<img :src="$withBase('/img/agregar-categoria-4.png')" width="300" height="300" hspace="200" vspace="50">

El Nombre es Obligatorio, y es el que el usuario quiera.

<img :src="$withBase('/img/agregar-categoria-5.png')" width="750" height="50" hspace="0" vspace="50">
...
<img :src="$withBase('/img/agregar-categoria-6.png')" width="400" height="100" hspace="150" vspace="50">
...
<img :src="$withBase('/img/agregar-categoria-8.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/editar-categoria-1.png')" width="300" height="150" hspace="200" vspace="50">
...
<img :src="$withBase('/img/editar-categoria-2.png')" width="500" height="400" hspace="100" vspace="50">
...
<img :src="$withBase('/img/eliminar-categoria-1.png')" width="300" height="150" hspace="200" vspace="50">

Aparecerá un mensaje, para confirmar que se eliminará.

<img :src="$withBase('/img/eliminar-categoria-2.png')" width="400" height="150" hspace="150" vspace="50">
...
<img :src="$withBase('/img/agregar-subcategoria-1.png')" width="300" height="150" hspace="200" vspace="50">
...
<img :src="$withBase('/img/agregar-subcategoria-2.png')" width="500" height="400" hspace="100" vspace="50">
...
<img :src="$withBase('/img/editar-subcategoria-1.png')" width="550" height="100" hspace="100" vspace="50">
...
<img :src="$withBase('/img/editar-subcategoria-2.png')" width="500" height="150" hspace="100" vspace="50">

Para editar una subcategoría de acuerdo a la lista, se da click en el 
botón editar (color azul con imagen).

<img :src="$withBase('/img/editar-subcategoria-3.png')" width="550" height="150" hspace="100" vspace="50">
...
<img :src="$withBase('/img/editar-subcategoria-4.png')" width="500" height="350" hspace="100" vspace="50">
...
<img :src="$withBase('/img/eliminar-subcategoria-1.png')" width="600" height="100" hspace="100" vspace="50">
...
<img :src="$withBase('/img/eliminar-subcategoria-2.png')" width="500" height="150" hspace="100" vspace="50">

Para eliminar una subcategoría de acuerdo a la lista, se da click en el 
botón eliminar (color rojo con imagen).

<img :src="$withBase('/img/eliminar-subcategoria-3.png')" width="500" height="150" hspace="150" vspace="50">

Aparecerá un mensaje, para confirmar que se eliminará.

<img :src="$withBase('/img/eliminar-subcategoria-4.png')" width="350" height="150" hspace="200" vspace="50">
...
<img :src="$withBase('/img/lista-de-catalogos-1.png')" width="400" height="150" hspace="150" vspace="50">
...
<img :src="$withBase('/img/agregar-elementos-catalogos-1.png')" width="200" height="150" hspace="250" vspace="50">

Deberá aparecer del lado derecho de la pantalla un cuadro como el 
siguiente.

<img :src="$withBase('/img/agregar-elementos-catalogos-2.png')" width="750" height="400" hspace="0" vspace="50">

Se debe de agregar el título del elemento en el catálogo y dar click
en el botón de color verde (+).

<img :src="$withBase('/img/agregar-elementos-catalogos-3.png')" width="500" height="200" hspace="100" vspace="50">
...
<img :src="$withBase('/img/editar-catalogo-1.png')" width="750" height="150" hspace="0" vspace="50">

Una vez hecho lo anterior, del lado derecho de la vista aparecerá la 
lista de elementos de cada catálogo.

<img :src="$withBase('/img/editar-catalogo-2.png')" width="400" height="300" hspace="150" vspace="50">

Se puede cambiar en el elemento: su nombre, activar o desactivar, 
dando click en el botón (imagen de lápiz).

<img :src="$withBase('/img/editar-catalogo-3.png')" width="400" height="300" hspace="150" vspace="50">
...
<img :src="$withBase('/img/editar-catalogo-4.png')" width="500" height="250" hspace="100" vspace="50">
...
<img :src="$withBase('/img/proveedores-1.png')" width="250" height="600" hspace="250" vspace="50">

La vista será la siguiente.

<img :src="$withBase('/img/proveedores-2.png')" width="750" height="250" hspace="0" vspace="50">

### Editar proveedor

Dar click en la imagen del proveedor a editar.

<img :src="$withBase('/img/editar-proveedor-1.png')" width="350" height="500" hspace="200" vspace="50">

<img :src="$withBase('/img/editar-proveedor-2.png')" width="250" height="400" hspace="250" vspace="0">

Se tendrá la siguiente vista, en la que se puede Editar el Nombre del 
proveedor, si estará activo o no.

<img :src="$withBase('/img/editar-proveedor-3.png')" width="500" height="450" hspace="100" vspace="50">

Puede añadir una url de la página web de su proveedor o cliente.

<img :src="$withBase('/img/editar-proveedor-4.png')" width="500" height="450" hspace="100" vspace="50">
...
<img :src="$withBase('/img/editar-proveedor-7.png')" width="600" height="200" hspace="100" vspace="50">
...
<img :src="$withBase('/img/agregar-producto-1.png')" width="300" height="600" hspace="150" vspace="50">
...
<img :src="$withBase('/img/agregar-producto-2.png')" width="750" height="400" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-1.png')" width="550" height="200" hspace="50" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-2.png')" width="550" height="100" hspace="50" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-3.png')" width="300" height="300" hspace="150" vspace="50">

* Proveedor (no obligatorio y de acuerdo a la lista de proveedores 
que se tiene), solo se puede seleccionar uno.

<img :src="$withBase('/img/pestaña-informacion-4.png')" width="450" height="150" hspace="150" vspace="50">

* Iva (obligatorio, de acuerdo con la lista que se encuentra en 
catálogos).

<img :src="$withBase('/img/pestaña-informacion-5.png')" width="400" height="150" hspace="150" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-7.png')" width="400" height="100" hspace="150" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-8.png')" width="300" height="300" hspace="200" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-9.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-10.png')" width="750" height="500" hspace="0" vspace="50">

En caso de que el producto que esté subiendo sea digital, deberá 
subir el archivo del mismo (una vez cargado, no podrá ser 
modificado después).

<img :src="$withBase('/img/pestaña-informacion-11.png')" width="750" height="250" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-12.png')" width="300" height="100" hspace="200" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-13.png')" width="500" height="100" hspace="100" vspace="50">

* Código de producto (mínimo 5 dígitos y Alfanumérico), dato 
opcional.

<img :src="$withBase('/img/pestaña-informacion-14.png')" width="500" height="50" hspace="100" vspace="50">

* Precio (obligatorio) se puede agregar hasta dos decimales.

<img :src="$withBase('/img/pestaña-informacion-15.png')" width="500" height="50" hspace="100" vspace="50">

* Precio de mayoreo (menor al precio normal, numérico) se 
puede agregar hasta dos decimales.

<img :src="$withBase('/img/pestaña-informacion-16.png')" width="500" height="50" hspace="100" vspace="50">

* Cantidad Mayoreo (opcional, numérico).

<img :src="$withBase('/img/pestaña-informacion-17.png')" width="500" height="50" hspace="100" vspace="50">

* Cantidad Mínima de Compra (opcional, numérico).

<img :src="$withBase('/img/pestaña-informacion-18.png')" width="500" height="50" hspace="100" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-19.png')" width="750" height="100" hspace="0" vspace="50">

* La opción de Página principal sirve para que el producto se vea 
como producto destacado al inicio de la página web.

<img :src="$withBase('/img/pestaña-informacion-20.png')" width="750" height="300" hspace="0" vspace="50">

* Es importante que se seleccione Visible al público para que el 
producto pueda ser observado en el sitio web.

<img :src="$withBase('/img/pestaña-informacion-21.png')" width="750" height="300" hspace="0" vspace="50">

* Promoción Precio (en caso de seleccionarlo se habilitarán las 
opciones:

<img :src="$withBase('/img/pestaña-informacion-22.png')" width="750" height="300" hspace="0" vspace="50">

1. Porcentaje: en donde el usuario debe de marcar la cantidad (no se 
permiten decimales) que prefiera.

<img :src="$withBase('/img/pestaña-informacion-23.png')" width="750" height="100" hspace="0" vspace="50">

2. Dinero: el usuario escribe la cantidad que prefiera (es posible escribir 
decimales).

<img :src="$withBase('/img/pestaña-informacion-24.png')" width="750" height="100" hspace="0" vspace="50">

* Promoción Cantidad: Se habilitarán dos casillas para marcar las 
dos cifras. Un ejemplo sería 2 productos por el precio de 1.

<img :src="$withBase('/img/pestaña-informacion-25.png')" width="750" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-informacion-26.png')" width="750" height="200" hspace="0" vspace="50">

* Una vez que se llenan los datos en la sección Producto se debe 
de dar click en el botón Guardar información (color azul).

<img :src="$withBase('/img/pestaña-informacion-27.png')" width="300" height="100" hspace="200" vspace="50">
...
<img :src="$withBase('/img/pestaña-atributos-1.png')" width="750" height="150" hspace="0" vspace="50">

Se puede o no seleccionar en Etiquetas las opciones que se requieran 
para el producto (todas o ninguna). 

<img :src="$withBase('/img/pestaña-atributos-2.png')" width="750" height="200" hspace="0" vspace="50">

Se puede o no seleccionar en País de Origen las opciones que se 
requieran para el producto (todas o ninguna). 

<img :src="$withBase('/img/pestaña-atributos-3.png')" width="750" height="250" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-adicional-1.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-adicional-2.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-seleccion-1.png')" width="750" height="250" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-seleccion-2.png')" width="250" height="100" hspace="200" vspace="50">

Se podrán agregar diferentes números (de selección rápida) dando 
click en Agregar.

<img :src="$withBase('/img/pestaña-seleccion-3.png')" width="500" height="300" hspace="150" vspace="50">
...
<img :src="$withBase('/img/pestaña-seleccion-6.png')" width="100" height="100" hspace="250" vspace="50">

Una vez que se agregó el producto, se ve reflejado en la sección Lista 
de productos.

<img :src="$withBase('/img/pestaña-seleccion-7.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/pestaña-seleccion-8.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-1.png')" width="750" height="300" hspace="0" vspace="50">

Para agregar un tipo de variante se da click en Agregar (botón color 
verde) inferior izquierdo.

<img :src="$withBase('/img/variantes-2.png')" width="300" height="200" hspace="150" vspace="50">
...
<img :src="$withBase('/img/variantes-3.png')" width="400" height="200" hspace="150" vspace="50">
...
<img :src="$withBase('/img/variantes-4.png')" width="400" height="150" hspace="150" vspace="50">
...
<img :src="$withBase('/img/variantes-5.png')" width="400" height="250" hspace="150" vspace="50">

Guardar la variante que se agregó dando click en el botón Guardar 
(color azul).

<img :src="$withBase('/img/variantes-6.png')" width="600" height="200" hspace="100" vspace="50">
...
<img :src="$withBase('/img/variantes-7.png')" width="500" height="250" hspace="100" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-1.png')" width="500" height="300" hspace="100" vspace="50">

En variantes atributos se presentará de la siguiente manera.

<img :src="$withBase('/img/variantes-atributos-2.png')" width="750" height="200" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-3.png')" width="600" height="100" hspace="100" vspace="50">

* Código de producto (mínimo 5 dígitos y Alfanumérico), dato 
opcional.

<img :src="$withBase('/img/variantes-atributos-4.png')" width="750" height="150" hspace="0" vspace="50">

* Precio (obligatorio) se puede agregar hasta dos decimales.

<img :src="$withBase('/img/variantes-atributos-5.png')" width="750" height="150" hspace="0" vspace="50">

* Precio de mayoreo (menor al precio normal, numérico) se 
puede agregar hasta dos decimales.

<img :src="$withBase('/img/variantes-atributos-6.png')" width="750" height="150" hspace="0" vspace="50">

* Cantidad Mayoreo (opcional, numérico).

<img :src="$withBase('/img/variantes-atributos-7.png')" width="750" height="150" hspace="0" vspace="50">

* Cantidad Mínima de Compra (opcional, numérico).

<img :src="$withBase('/img/variantes-atributos-8.png')" width="750" height="150" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-9.png')" width="750" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-10.png')" width="500" height="200" hspace="150" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-11.png')" width="750" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-12.png')" width="750" height="100" hspace="0" vspace="50">

* Promoción Cantidad: Se habilitarán dos casillas para marcar las dos 
cifras. Un ejemplo sería 2 productos por el precio de 1.

<img :src="$withBase('/img/variantes-atributos-13.png')" width="750" height="100" hspace="0" vspace="50">
...
<img :src="$withBase('/img/variantes-atributos-14.png')" width="750" height="200" hspace="0" vspace="50">

* Una vez que se llenan los datos en la sección Producto se debe 
de dar click en el botón Guardar información (color azul).

<img :src="$withBase('/img/variantes-atributos-15.png')" width="300" height="100" hspace="200" vspace="50">
...
<img :src="$withBase('/img/lista-de-productos-1.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/lista-de-productos-2.png')" width="300" height="300" hspace="150" vspace="50">

<img :src="$withBase('/img/lista-de-productos-3.png')" width="300" height="100" hspace="150" vspace="0">
...
<img :src="$withBase('/img/lista-de-productos-4.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/lista-de-productos-5.png')" width="750" height="300" hspace="0" vspace="50">

Visualización de un producto en el sitio web.

<img :src="$withBase('/img/lista-de-productos-6.png')" width="750" height="400" hspace="0" vspace="50">
...
<img :src="$withBase('/img/editar-producto-1.png')" width="750" height="250" hspace="0" vspace="50">
...
<img :src="$withBase('/img/editar-producto-2.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/secciones-1.png')" width="750" height="400" hspace="0" vspace="50">
...
<img :src="$withBase('/img/secciones-2.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/secciones-3.png')" width="100" height="100" hspace="250" vspace="50">

Aparecerá la siguiente vista, en la que se podrán agregar las 
secciones que se quieran.

<img :src="$withBase('/img/secciones-4.png')" width="750" height="450" hspace="0" vspace="50">
...
<img :src="$withBase('/img/secciones-5.png')" width="750" height="500" hspace="0" vspace="50">

Se debe de habilitar o deshabilitar la sección antes de guardar 
cambios.

<img :src="$withBase('/img/secciones-6.png')" width="300" height="100" hspace="200" vspace="50">

Seleccionar si se quiere ver la sección como destacada.

<img :src="$withBase('/img/secciones-7.png')" width="250" height="100" hspace="200" vspace="50">

Seleccionar un ícono para la sección.

<img :src="$withBase('/img/secciones-8.png')" width="250" height="100" hspace="200" vspace="50">

<img :src="$withBase('/img/secciones-9.png')" width="500" height="200" hspace="100" vspace="50">
...
<img :src="$withBase('/img/secciones-10.png')" width="200" height="100" hspace="250" vspace="50">
...
<img :src="$withBase('/img/secciones-11.png')" width="300" height="300" hspace="200" vspace="50">
...
<img :src="$withBase('/img/secciones-12.png')" width="400" height="300" hspace="200" vspace="50">

Hechas las modificaciones, se da click en el botón Guardar (color 
azul).

<img :src="$withBase('/img/secciones-13.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/secciones-14.png')" width="300" height="100" hspace="200" vspace="50">

* La sección aparece habilitada en color negro.

<img :src="$withBase('/img/secciones-15.png')" width="300" height="300" hspace="200" vspace="50">

* Secciones habilitadas que se muestran en la página de la 
tienda.

<img :src="$withBase('/img/secciones-16.png')" width="750" height="300" hspace="0" vspace="50">

* Las secciones marcadas como destacadas aparecerán en la 
parte superior derecha de la tienda.

<img :src="$withBase('/img/secciones-17.png')" width="750" height="400" hspace="0" vspace="50">
...
<img :src="$withBase('/img/redes-sociales-1.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/redes-sociales-2.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/redes-sociales-3.png')" width="200" height="150" hspace="200" vspace="50">

Elija las preferencias de color y posición para sus redes sociales en 
formato flotante:

<img :src="$withBase('/img/redes-sociales-4.png')" width="750" height="300" hspace="0" vspace="50">

Una vez que se agregó la(s) red(es) social(es), se da click en Guardar 
(botón azul).

<img :src="$withBase('/img/redes-sociales-5.png')" width="250" height="100" hspace="200" vspace="50">

Los cambios se deben ver reflejados en la parte inferior de la página 
web.

<img :src="$withBase('/img/redes-sociales-6.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/promociones-1.png')" width="750" height="150" hspace="0" vspace="50">
...
<img :src="$withBase('/img/promociones-2.png')" width="500" height="300" hspace="100" vspace="50">
...
<img :src="$withBase('/img/promociones-3.png')" width="500" height="300" hspace="100" vspace="50">
...
<img :src="$withBase('/img/promociones-4.png')" width="300" height="300" hspace="200" vspace="50">

Una vez que se agregó la promoción, se debe de dar click en el botón 
Guardar (color azul).

<img :src="$withBase('/img/promociones-5.png')" width="250" height="100" hspace="200" vspace="50">
...
<img :src="$withBase('/img/promociones-6.png')" width="400" height="300" hspace="150" vspace="50">

Una vez realizados los cambios se debe de dar click en el botón 
Guardar (color azul).

<img :src="$withBase('/img/promociones-7.png')" width="250" height="100" hspace="200" vspace="50">
...
<img :src="$withBase('/img/sucursales-1.png')" width="750" height="400" hspace="0" vspace="50">
...
<img :src="$withBase('/img/sucursales-2.png')" width="100" height="100" hspace="250" vspace="50">

Se deben de agregar los siguientes datos (obligatorios): Nombre, 
Correo (con formato correspondiente), Teléfono (10 dígitos), 
Dirección.

<img :src="$withBase('/img/sucursales-3.png')" width="500" height="250" hspace="100" vspace="50">

Después de agregar los datos principales de la tienda, se da click en 
Configurar horarios (botón color azul).

<img :src="$withBase('/img/sucursales-4.png')" width="500" height="250" hspace="100" vspace="50">
...
<img :src="$withBase('/img/sucursales-5.png')" width="600" height="300" hspace="50" vspace="50">
...
<img :src="$withBase('/img/sucursales-6.png')" width="600" height="300" hspace="50" vspace="50">
...
<img :src="$withBase('/img/sucursales-7.png')" width="750" height="400" hspace="0" vspace="50">

Una vez que se agregó la ubicación se deberá dar click en la flecha 
naranja en la parte inferior derecha.

<img :src="$withBase('/img/sucursales-8.png')" width="100" height="100" hspace="250" vspace="50">
...
<img :src="$withBase('/img/sucursales-9.png')" width="600" height="300" hspace="50" vspace="50">
...
<img :src="$withBase('/img/sucursales-10.png')" width="750" height="300" hspace="0" vspace="50">

<img :src="$withBase('/img/sucursales-11.png')" width="750" height="300" hspace="0" vspace="0">
...
<img :src="$withBase('/img/sucursales-12.png')" width="600" height="300" hspace="50" vspace="50">

Una vez que se hagan los cambios, se debe de dar click en Guardar 
(botón verde).

<img :src="$withBase('/img/sucursales-13.png')" width="600" height="300" hspace="50" vspace="50">
...
<img :src="$withBase('/img/sucursales-14.png')" width="750" height="400" hspace="0" vspace="50">

<img :src="$withBase('/img/sucursales-15.png')" width="750" height="400" hspace="0" vspace="0">
...
<img :src="$withBase('/img/newsletter-1.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/newsletter-2.png')" width="750" height="300" hspace="0" vspace="50">

<img :src="$withBase('/img/newsletter-3.png')" width="750" height="300" hspace="0" vspace="0">

<img :src="$withBase('/img/newsletter-4.png')" width="750" height="300" hspace="0" vspace="0">
...
<img :src="$withBase('/img/newsletter-5.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/newsletter-6.png')" width="750" height="300" hspace="0" vspace="50">

Seleccione el botón de Guardar al finalizar el proceso.

<img :src="$withBase('/img/newsletter-7.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/newsletter-8.png')" width="750" height="200" hspace="0" vspace="50">
...
<img :src="$withBase('/img/newsletter-9.png')" width="750" height="200" hspace="0" vspace="50">
...
<img :src="$withBase('/img/envios-8.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/envios-9.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/envios-10.png')" width="500" height="300" hspace="100" vspace="50">
...
<img :src="$withBase('/img/envios-11.png')" width="750" height="300" hspace="0" vspace="50">

En caso de requerirlo, usted puede realizar una búsqueda 
personalizada en la sección que se marca en la imagen:

<img :src="$withBase('/img/envios-12.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-1.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-2.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-3.png')" width="350" height="300" hspace="150" vspace="50">
...
<img :src="$withBase('/img/ventas-4.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-5.png')" width="750" height="300" hspace="0" vspace="50">

Cuando ya haya elegido los elementos de su interés, sus productos 
añadidos aparecerán de la siguiente forma:

<img :src="$withBase('/img/ventas-6.png')" width="750" height="300" hspace="0" vspace="50">

Una vez que haya verificado que los datos sean correctos, puede 
oprimir el botón Generar Venta.

<img :src="$withBase('/img/ventas-7.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-8.png')" width="750" height="300" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-9.png')" width="750" height="500" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-10.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-11.png')" width="750" height="350" hspace="0" vspace="50">
...
<img :src="$withBase('/img/ventas-12.png')" width="750" height="150" hspace="0" vspace="50">
